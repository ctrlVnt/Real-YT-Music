...
<img src="https://riccardoventurini.dev/images/rytm.png" width="700" />
...
- **Add a new language:**  
  Create a new `values-*` folder using the ISO 639-1 language code and include a translated `strings.xml`.
